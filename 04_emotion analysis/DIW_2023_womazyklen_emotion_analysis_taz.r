...
sInFile5 = "Data/taz/taz_Housing_articles_unambiguous_withtopics_2022-06-09.rds"

sOutFile = paste("Data/taz/articlelists_sentiment/emotion_analysis_Taz_Housing_", dict,"_", lemma, "_lemma.xlsx", sep="")
sOutFile2 = paste("Data/taz/taz_Housing_lemma.rds", sep="")
sOutFile3 = "Data/Taz/articlelists_sentiment/Taz_Housing_emotion_count.xlsx"
...
# Load all taz articles dealing with housing market
# -----------------------------------------------
...
for(i in 1:NCorpus)
{
  ...
  # Example for Anger:
  # ------------------
  #vector of intersection of words in article and words with associated with anger in dictionary
