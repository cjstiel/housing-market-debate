...
# ------------------------------------------------------------------------------
#
#	 	CONTENT: SENTIMENT ANALYSIS (F.A.Z.)
#
...
#
# First created --- August 24, 2022									
# Last modified --- August, 2022 (cs)
# ------------------------------------------------------------------------------
...
sInFile8 = "Data/FAZ/FAZ_Housing_articles_unambiguous_withtopics_2022-08-23.rds"

sOutFile1 = paste0("Data/FAZ/articlelists_sentiment/Sentiment_FAZ_Housing_", lemma, "_lemma_",dict,".xlsx")
sOutFile2 = paste0("Data/FAZ/articlelists_sentiment/Words_positive_Sentiment_FAZ_Housing_", lemma, "_lemma_",dict,".txt")
sOutFile3 = paste0("Data/FAZ/articlelists_sentiment/Words_negative_Sentiment_FAZ_Housing_", lemma, "_lemma_",dict,".txt")
sOutFile4 = paste0("Data/FAZ/articlelists_sentiment/Words_positive_Sentiment_FAZ_Housing_", lemma, "_lemma_",dict,".rds")
sOutFile5 = paste0("Data/FAZ/articlelists_sentiment/Words_negative_Sentiment_FAZ_Housing_", lemma, "_lemma_",dict,".rds")
