...
# ------------------------------------------------------------------------------
#
#	 	CONTENT: SENTIMENT ANALYSIS FOR SUB TOPICS (taz)
#
...
#
# First created --- June 17, 2022									
# Last modified --- June 20, 2022 (cs)
# ------------------------------------------------------------------------------
# content: This code conducts the sentiment analysis for the articles in the
# newspaper 'taz' that focus on the sub topic "housing markets and rent issues".
# ==============================================================================
...
sInFile8 = "Data/taz/topic model top terms/k=11 neu/only housing/taz_Housing_articles_unambiguous_withtopics_only_housing_market_2022-06-17.rds"

sOutFile1 = paste0("Data/taz/articlelists_sentiment/Sentiment_taz_Housing_subtopicRents", lemma, "_lemma_",dict,".xlsx")
sOutFile2 = paste0("Data/taz/articlelists_sentiment/Words_positive_Sentiment_taz_Housing_subtopicRents", lemma, "_lemma_",dict,".rds")
sOutFile3 = paste0("Data/taz/articlelists_sentiment/Words_negative_Sentiment_taz_Housing_subtopicRents", lemma, "_lemma_",dict,".rds")
...
# ---------------------------
saveRDS(df_pos, paste0(sFolder1, sOutFile2))
saveRDS(df_neg, paste0(sFolder1, sOutFile3))
