...
# ------------------------------------------------------------------------------
#
#	 	CONTENT: IDENTIFY HOUSING-MARKET RELATED ARTICLES (taz)
#
...
sInFile = "Data/taz/article_texts/taz_articles_1991-2021.rds"
sInFile2 = "housing_market_keywords.xlsx"
sOutFile = "Data/taz/taz_list_articles_with_keywords_1991-2021.rds"
sOutFile2 = "Data/taz/taz_articles_with_keywords_1991-2021.rds"
sOutFile3 = "Data/taz/taz_Housing_articles_unambiguous_2022-05-09.xlsx"
sOutFile4 = "Data/taz/taz_Housing_articles_unambiguous_withText_2022-05-09.rds"
sOutFile_graph1 = "Draft/figures/data-preparation/Fig_Housing_notions_frequency_taz.pdf"
sOutFile_graph2 = "Draft/figures/data-preparation/Fig_Housing_notions_most_common_keywords_taz.pdf"
sOutFile_graph3 = "Draft/figures/data-preparation/Fig_Housing_market_articles_per_year_taz.pdf"
...
plot(table(X_sel$Year),type="l",ylab="number of articles"
     ,xlab="year",lwd=5,bty="l",main="taz articles on housing issues"
     ,font.main=1,las=1)
segments(x0=2004,y0=-60,x1=2004,y1=1078,col="red",lwd=2)
segments(x0=2008,y0=-60,x1=2008,y1=754,col="red",lwd=2)
segments(x0=2013,y0=-60,x1=2013,y1=1284,col="red",lwd=2)
segments(x0=2019,y0=-60,x1=2019,y1=1541,col="red",lwd=2)
text(2005,100,"2004",srt=90)
text(2009,100,"2008",srt=90)
...
plot(table(X_sel$Year),type="l",ylab="Anzahl der Artikel"
     ,xlab="Jahr",lwd=5,bty="l",main="taz Artikel zum Thema Wohnungsmarkt"
     ,font.main=1,las=1,xaxt="n")
axis(1, at=seq(1946,2013,5), labels=seq(1946,2013,5))
...
# share in total number of taz articles 
# --------------------------------------
round(table(X_sel$Year)/table(X$Year),3)

# English graph
# -------------
par(mar=c(5,5,5,1))
plot(round(table(X_sel$Year)/table(X$Year)*100,1),type="l"
     ,ylab="share of articles in %",xlab="year",lwd=5,bty="l",las=1
     ,main="share of articles on housing issues \n in total number of taz articles"
     ,font.main=1)
#abline(v=c(1971,1981,1990,1998,2008),col="red",lwd=2)
segments(x0=2019,y0=-60,x1=2019,y1=5.1,col="red",lwd=2)
text(2020,.5,"2019",srt=90)
...
barplot(height=keywords_unamb_freq[20:1,2],horiz=TRUE
        ,col=c("cyan4",rep("yellow3",2),"cyan4","yellow3","cyan4","red4",rep("cyan4",3)
               ,rep("red4",2),rep("cyan4",2),rep("red4",2),rep("cyan4",3),"red4")
